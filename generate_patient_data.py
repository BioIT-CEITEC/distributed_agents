...
PATHOGENIC_VARIANTS = {
    ...
    "rs75961395": {"gene": "CFTR", "disease": "Cystic Fibrosis", 
                   "freq_in_cases": 0.40, "freq_in_controls": 0.002},
    "rs113993960": {"gene": "CFTR", "disease": "Cystic Fibrosis", 
                    "freq_in_cases": 0.65, "freq_in_controls": 0.003},
    "rs121908745": {"gene": "CFTR", "disease": "Cystic Fibrosis", 
                    "freq_in_cases": 0.35, "freq_in_controls": 0.001},
    "rs121909001": {"gene": "CFTR", "disease": "Cystic Fibrosis", 
                    "freq_in_cases": 0.25, "freq_in_controls": 0.001},
    
    # Huntington Disease variants (HTT gene)
    "rs121909298": {"gene": "HTT", "disease": "Huntington Disease", 
                    "freq_in_cases": 0.90, "freq_in_controls": 0.0001},
    "rs121909299": {"gene": "HTT", "disease": "Huntington Disease", 
                    "freq_in_cases": 0.10, "freq_in_controls": 0.00005},
    
    # Duchenne Muscular Dystrophy (DMD gene)
    "rs128625267": {"gene": "DMD", "disease": "Duchenne Muscular Dystrophy", 
                    "freq_in_cases": 0.45, "freq_in_controls": 0.00005},
    "rs128625268": {"gene": "DMD", "disease": "Duchenne Muscular Dystrophy", 
                    "freq_in_cases": 0.35, "freq_in_controls": 0.00004},
    "rs398123529": {"gene": "DMD", "disease": "Duchenne Muscular Dystrophy", 
                    "freq_in_cases": 0.20, "freq_in_controls": 0.00003},
    
    # Sickle Cell Disease (HBB gene)
    "rs334": {"gene": "HBB", "disease": "Sickle Cell Disease", 
              "freq_in_cases": 0.75, "freq_in_controls": 0.002},
    "rs33930165": {"gene": "HBB", "disease": "Sickle Cell Disease", 
                   "freq_in_cases": 0.15, "freq_in_controls": 0.0005},
    "rs35497102": {"gene": "HBB", "disease": "Sickle Cell Disease", 
                   "freq_in_cases": 0.10, "freq_in_controls": 0.0003},
    
    # Hereditary Breast Cancer (BRCA1/BRCA2)
    "rs80357906": {"gene": "BRCA1", "disease": "Hereditary Breast Cancer", 
                   "freq_in_cases": 0.35, "freq_in_controls": 0.001},
    "rs80356920": {"gene": "BRCA1", "disease": "Hereditary Breast Cancer", 
                   "freq_in_cases": 0.25, "freq_in_controls": 0.0008},
    "rs80359550": {"gene": "BRCA2", "disease": "Hereditary Breast Cancer", 
                   "freq_in_cases": 0.30, "freq_in_controls": 0.0015},
    "rs80358947": {"gene": "BRCA2", "disease": "Hereditary Breast Cancer", 
                   "freq_in_cases": 0.20, "freq_in_controls": 0.0006},
    
    # Lynch Syndrome (MLH1, MSH2, MSH6, PMS2)
    "rs63750217": {"gene": "MLH1", "disease": "Lynch Syndrome", 
                   "freq_in_cases": 0.30, "freq_in_controls": 0.002},
    "rs63750449": {"gene": "MSH2", "disease": "Lynch Syndrome", 
                   "freq_in_cases": 0.25, "freq_in_controls": 0.0018},
    "rs121909001": {"gene": "MSH6", "disease": "Lynch Syndrome", 
                    "freq_in_cases": 0.20, "freq_in_controls": 0.0015},
    "rs121434629": {"gene": "PMS2", "disease": "Lynch Syndrome", 
...
def generate_patient_cohort(node_id: str, total_patients: int = 500, regional_variation: float = 0.1):
    ...
    regional_factor = 1 + np.random.uniform(-regional_variation, regional_variation, 
                                           size=len(CASES_PER_DISEASE))
    ...
    for i, (disease, base_n_cases) in enumerate(CASES_PER_DISEASE.items()):
        ...
        disease_variants = {k: v for k, v in PATHOGENIC_VARIANTS.items() 
                           if v["disease"] == disease}
        
        # Generate cases (patients with the disease)
        for _ in range(n_cases):
            patient = {
                "patient_id": f"{node_id}_P{patient_id_counter:04d}",
                "node_id": node_id,
                "disease": disease,
                "has_disease": True
            }
            ...
            for variant_id, variant_info in PATHOGENIC_VARIANTS.items():
                if variant_info["disease"] != disease and variant_id not in patient:
...
def generate_variant_metadata():
    ...
    for variant_id, info in PATHOGENIC_VARIANTS.items():
        ...
        metadata[variant_id] = {
            "gene": info["gene"],
            "associated_disease": info["disease"],
...
def main():
    ...
    for i in range(1, 5):
        ...
        filename = f"patients_{node_id}.csv"
        ...
        for disease in CASES_PER_DISEASE.keys():
            ...
            n_case = disease_df['has_disease'].sum()
        ...
        if i == 1:  # Only show for first node
            ...
            cf_data = df[df['disease'] == 'Cystic Fibrosis']
            if 'rs113993960' in cf_data.columns:
                cf_cases = cf_data[cf_data['has_disease'] == True]
                cf_controls = cf_data[cf_data['has_disease'] == False]
